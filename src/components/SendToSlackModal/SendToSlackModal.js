  ...
  renderEmptyListMessage = () => {
    return (
      <div className="slack-modal-empty-list-message">
        <div>
          You don't have any <Icon type="slack" /> Slack channels connected yet.
        </div>
        <Button
          type="primary"
          onClick={() => {
    ...
    return (
      <div className="slack-channel-list-container">
        <div className="slack-channel-list">
          <div>
            AutoQL will post an email to the selected Slack channel with the{' '}
          ...
          <div className="select-channel-titles">
            ...
            <Select
              ...
              style={{ width: '300px' }}
              selectionPlaceholder="Select a Slack Channel"
              onChange={(value) => {
    ...
    return (
      <div className="connect-channel-form-container">
        <div className="connect-channel-form">
          <div className="connect-channel-title">Connect a Slack Channel</div>
          <Icon
          ...
          <div>
            ...
            <Popover
              isOpen={this.state.isSlackEmailInstructionVisible}
              onClickOutside={() =>
            ...
            >
              <span
                ...
                onClick={() => {
                  this.setState({ isSlackEmailInstructionVisible: true })
                }}
              >
          ...
          <Input
            placeholder="e.g. 1234@slack.com"
          ...
          <div>
            ...
            <span className="form-subtitle">
              (Displayed as sender name in Slack)
            </span>
          </div>
          <Input
          ...
          <div>
            Your Email{' '}
            <span className="form-subtitle">
              (Displayed as sender email in Slack)
            </span>
          </div>
          <Input
      ...
      return (
        <div>
          <Button
            ...
            onClick={this.sendDataToSlack}
            loading={this.state.isSendingData}
          >
            <Icon type="send" /> Send to Slack
          </Button>
        </div>
      )
    }
